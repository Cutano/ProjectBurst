...
namespace Burst
{
    ...
    public:
        virtual glm::vec3 emitted(
            const ray &r_in, const hit_record &rec, double u, double v, const glm::vec3 &p) const
        {
    ...
    public:
        ...
        {
            auto cosine = dot(rec.normal, glm::normalize(scattered.direction()));
    ...
    public:
            ...
            const ray &r_in, const hit_record &rec, scatter_record &srec) const override
        {
            ...
            if (cannot_refract || reflectance(cos_theta, refraction_ratio) > random_double())
                ...
                direction = refract(unit_direction, rec.normal, static_cast<float>(refraction_ratio));
    ...
    public:
        ...
        virtual glm::vec3 emitted(
            const ray &r_in, const hit_record &rec, double u, double v, const glm::vec3 &p) const override
        {
            if (!rec.front_face)
                return glm::vec3(0, 0, 0);
